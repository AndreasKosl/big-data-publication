...
Big Data has no defined starting point. It was rather a smooth transition as firms started to analyse their data to get a benefit from it. Through the constant reduction of storage from \textdollar 700/MB in 1981 to \textdollar 0.0002/MB in 2006 \cite{PCMAGAZINE} and the invention of new technologies, especially the internet, firms were able to get a grip of more data than ever before. 
